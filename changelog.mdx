...
<Update label="Apr 24, 2026" tags={["What's new", "Breaking", "Integrations"]}>
  ...
  - Install works today via `zombiectl install --from samples/platform-ops`.
  ...
  <Note>
    Chatting with an installed platform-ops zombie is coming soon. The install path succeeds today, but the zombie sits idle until the worker and executor updates land in the next release train.
  </Note>
</Update>

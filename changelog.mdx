...
<Update label="v0.17.0 — Apr 16, 2026" tags={["Breaking", "API", "CLI"]}>
  ...
  `public/openapi.json` pruned: 8 stale paths removed (`/v1/runs/*` retired in v0.10, and an orphaned `skills/*/secrets/*`). SDKs generated from the spec no longer surface methods the server never had.

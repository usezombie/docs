...
Once registered, the agent can call `zombiectl install --from`, `zombiectl credential`, `zombiectl steer`, `zombiectl events`, and other commands natively without manual invocation.

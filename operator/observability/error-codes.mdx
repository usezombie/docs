---
title: "Error codes"
description: "UZ-* error code reference."
---
...
| Code | Meaning | Remediation |
|------|---------|-------------|
| `UZ-CRED-001` | GitHub App token request failed | The JWT signature was rejected by GitHub. Verify the GitHub App private key in your secret manager matches the installed app. Re-download the key from GitHub App settings if needed. |
| `UZ-CRED-002` | Anthropic API key invalid | The API key was rejected by Anthropic. Verify the key in your secret manager is current. Rotate it at console.anthropic.com if needed. |

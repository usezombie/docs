...
23 tools are user-callable today. They group into nine categories below. For the file format, validation rules, and frontmatter, see [Authoring a zombie](/zombies/authoring).

...
Streams the activity log for a single zombie. The activity log is an append-only audit stream — every webhook received, every skill invoked, every response returned, every budget check.
...
Activity Stream
─────────────────────────────────────────────────────────────────
  2026-04-18T15:22:31Z  webhook_received  email.inbound from alice@example.com

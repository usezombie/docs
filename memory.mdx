...
[Event ends, workspace destroyed]
...
[separately, async — every 5 min]
    → memory_metrics aggregator reads zombie_events + memory_feedback
    → writes rolled-up rates keyed by zombie_id

...
| `UZ-AUTH-002` | 401 | Unauthorized | Missing, invalid, or expired Bearer token |
...
| `UZ-ENTL-002` | 402 | Profile limit reached | Plan does not allow more agent profiles |
...
| `UZ-AGENT-002` | 503 | Agent scores unavailable | Score data not yet computed for this agent |

...
<Warning>
  **🚧 In Development** — UseZombie is under active development and releasing on **April 5, 2026**. APIs, CLI commands, and behaviors described in these docs may change before the public release.
</Warning>

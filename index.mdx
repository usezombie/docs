...
A **Zombie** is a preconfigured agent workflow that does one job and stays alive forever. You configure it: what tools it attaches, what credentials it uses, what budget it has, what triggers it. The agent intelligence is built in.

...
<Columns cols={2}>
  ...
  <Card title="The credential firewall" icon="shield-halved">
    The model never sees raw secret bytes. The firewall substitutes them outside the sandbox; a prompt-injection attack recovers only a placeholder. <a href="/zombies/credentials">More →</a>
  </Card>
